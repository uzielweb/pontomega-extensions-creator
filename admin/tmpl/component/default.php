		...
		<div class="col-md-6 offset-md-3">
			<div class="card shadow-sm">
				<div class="card-header bg-primary text-white">
					<h3 class="card-title mb-0"><span class="icon-bricks" aria-hidden="true"></span> <?php echo JText::_('COM_EXTENSIONSCREATOR_CREATE_COMPONENT'); ?></h3>
				</div>
				<div class="card-body">
					<fieldset class="options-form">
						<legend class="visually-hidden"><?php echo JText::_('COM_EXTENSIONSCREATOR_CREATE_COMPONENT'); ?></legend>

						<div class="mb-3">
							<label for="jform_element" class="form-label"><?php echo JText::_('COM_EXTENSIONSCREATOR_ELEMENT'); ?> (e.g., com_example) <span class="text-danger">*</span></label>
						...
						<div class="mb-3">
							<label for="jform_views" class="form-label"><?php echo JText::_('COM_EXTENSIONSCREATOR_VIEWS'); ?></label>
						...
						<div class="mb-3">
							<label for="jform_tables" class="form-label"><?php echo JText::_('COM_EXTENSIONSCREATOR_TABLES'); ?></label>
