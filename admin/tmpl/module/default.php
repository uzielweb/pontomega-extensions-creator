		...
		<div class="col-md-6">
			<div class="card">
				<div class="card-header bg-primary text-white">
					<h3 class="card-title mb-0"><span class="icon-bricks" aria-hidden="true"></span> <?php echo JText::_('COM_EXTENSIONSCREATOR_CREATE_MODULE'); ?></h3>
				</div>
				<div class="card-body">
					<fieldset class="options-form">
						<legend class="visually-hidden"><?php echo JText::_('COM_EXTENSIONSCREATOR_CREATE_MODULE'); ?></legend>

						<div class="mb-3">
							<label for="jform_element" class="form-label"><?php echo JText::_('COM_EXTENSIONSCREATOR_ELEMENT'); ?> (e.g., mod_example) <span class="text-danger">*</span></label>
							<div class="input-group">
								<span class="input-group-text">mod_</span>
								<input type="text" name="jform[element]" id="jform_element" class="form-control" required placeholder="example">
							</div>
							<div class="form-text">The internal name of your module.</div>
						</div>
